// Етап 2 — Додамо яскравих фарб у наш лабіринт - метод GetColor
...
class Program
{
    ...
    private static ConsoleColor GetColor(string symbol)
    {
        ...
        {
            string s when s == spikesActiveSymbol => ConsoleColor.DarkGray,
            string s when s == spikesDeactiveSymbol => ConsoleColor.Red,
