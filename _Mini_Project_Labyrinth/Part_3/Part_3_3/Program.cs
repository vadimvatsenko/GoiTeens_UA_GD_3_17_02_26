// Етап 3 — CheckSymbol(шипи, життя, хіл, збір монет і тд)
...
class Program
{
    ...
    private static int spikesDamage;
    ...
    private static void PlayLevel(int len, int wid, int wallPercent, int coinsPercent, int bombsPercent,
        int healPercent, int spikesPercent)
    {
