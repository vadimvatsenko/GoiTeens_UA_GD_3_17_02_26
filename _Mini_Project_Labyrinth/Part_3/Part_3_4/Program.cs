//Етап 4 — Відображення зібраних предметів та покращена взаємодія

//Пункт 3 - Правильно обробляти смерть гравця
//Пункт 4 - Правильно обновляти параметри при запуску кожного рівня

// Дмитро проєкт
// Питання з приводу ДЗ - чи воно є??
// ДЗ Тимур
